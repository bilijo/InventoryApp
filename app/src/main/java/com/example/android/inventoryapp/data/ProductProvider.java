...
public class ProductProvider  extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        Integer qty = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_PRICE);
        if (qty != null && qty < 0) {
            throw new IllegalArgumentException("Product requires valid price");
        }


        // If the price is provided, check that it's greater than or equal to 0.0
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_QTY)) {
            ...
            Integer qty = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_QTY);
            if (qty != null && qty < 0) {
